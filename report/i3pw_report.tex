...
\hypersetup{
  ...
  pdfauthor={Bjarni Johann Vilhjalmsson},
...
margins can refute the tilt; they do not prove it.  Numeric claims below are
copied from the frozen table \path{report/validation_results.tsv} (i3pw 0.3.0,
11 August 2026).  They are fixed-seed simulations, not external-cohort
validation.
\end{abstract}
...
Theoretical links, unit tests, and the 0.3.0 synthetic freeze in
\path{report/validation_results.tsv}.  There is no reported external-cohort
validation. \\
\bottomrule
\end{tabularx}
\end{table}
...
\subsection{Frozen synthetic table}
...
\begin{axis}[
  ...
  height=5.0cm,
  title={\textbf{A}\quad Unanchored disease error},
  ylabel={Mean absolute error (\%)},
  symbolic x coords={N,L,U},
  xtick={N,L,U},
  xticklabels={Naive,LASSO + cal.,Uniform + cal.},
  x tick label style={font=\scriptsize, rotate=18, anchor=east},
  tick label style={font=\scriptsize, text=black!75},
  label style={font=\scriptsize},
  title style={font=\small, yshift=3pt},
  axis x line*=bottom,
  axis y line*=left,
  axis line style={draw=black!45, line width=0.5pt},
  tick style={draw=black!45, line width=0.5pt},
  ymajorgrids,
...
\addplot+[
  ybar, bar width=18pt, bar shift=0pt, draw=none, fill=i3Gray, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=1]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt},
  error bars/.cd, y dir=both, y explicit,
  error bar style={draw=black!65, line width=0.7pt},
  error mark options={draw=black!65, rotate=90, mark size=2.5pt, line width=0.7pt}
] coordinates {(N,80.779) +- (0,6.662)};
\addplot+[
  ybar, bar width=18pt, bar shift=0pt, draw=none, fill=i3Blue, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=1]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt},
  error bars/.cd, y dir=both, y explicit,
  error bar style={draw=black!65, line width=0.7pt},
  error mark options={draw=black!65, rotate=90, mark size=2.5pt, line width=0.7pt}
] coordinates {(L,81.611) +- (0,6.030)};
\addplot+[
  ybar, bar width=18pt, bar shift=0pt, draw=none, fill=i3Teal, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=1]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt},
  error bars/.cd, y dir=both, y explicit,
...
\begin{axis}[
  width=0.96\linewidth,
  height=5.0cm,
  title={\textbf{B}\quad Held-out covariate balance},
  ylabel={Worst held-out \(|\mathrm{SMD}|\)},
  symbolic x coords={L,U},
  xtick={L,U},
  xticklabels={LASSO base,Uniform base},
...
\addplot+[
  ybar, bar width=22pt, bar shift=0pt, draw=none, fill=i3Blue, mark=none,
  ...
  error bar style={draw=black!65, line width=0.7pt},
  error mark options={draw=black!65, rotate=90, mark size=2.5pt, line width=0.7pt}
] coordinates {(L,0.209) +- (0,0.079)};
\addplot+[
  ybar, bar width=22pt, bar shift=0pt, draw=none, fill=i3Teal, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=3]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt},
  error bars/.cd, y dir=both, y explicit,
  error bar style={draw=black!65, line width=0.7pt},
  error mark options={draw=black!65, rotate=90, mark size=2.5pt, line width=0.7pt}
] coordinates {(U,0.482) +- (0,0.238)};
\draw[black!50, densely dashed, line width=0.6pt]
  (axis cs:L,0.1) -- (axis cs:U,0.1);
\node[font=\tiny, text=black!60, anchor=south east]
  at (axis cs:U,0.1) {0.1 heuristic};
\end{axis}
\end{tikzpicture}
\end{minipage}
...
\begin{axis}[
  width=0.96\linewidth,
  height=4.8cm,
  title={\textbf{C}\quad Participant-only trait error},
  ylabel={Mean absolute bias},
  symbolic x coords={N,I,C,A},
  xtick={N,I,C,A},
  xticklabels={Naive,LASSO IPW,Calibration,AIPW},
...
\addplot+[
  ybar, bar width=17pt, bar shift=0pt, draw=none, fill=i3Gray, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=3]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt}
] coordinates {(N,0.1008)};
\addplot+[
  ybar, bar width=17pt, bar shift=0pt, draw=none, fill=i3Blue, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=3]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt}
] coordinates {(I,0.0636)};
\addplot+[
  ybar, bar width=17pt, bar shift=0pt, draw=none, fill=i3Teal, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=3]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt}
] coordinates {(C,0.0864)};
\addplot+[
  ybar, bar width=17pt, bar shift=0pt, draw=none, fill=i3Gold, mark=none,
  nodes near coords={\pgfmathprintnumber[fixed,precision=3]{\pgfplotspointmeta}},
  every node near coord/.append style={font=\scriptsize\bfseries, text=white,
    anchor=north, yshift=-2pt}
] coordinates {(A,0.0584)};
\end{axis}
\end{tikzpicture}
\end{minipage}
...
The numeric evidence in \S\ref{sec:evidence} is the 0.3.0 freeze in
\path{report/validation_results.tsv}.  It supports the narrow messages
already in the documentation: transfer across unanchored diseases is
weak, the covariate base matters when selection has a covariate
channel, and anchored zeros are identities.  It does not establish
bias reduction in a real cohort.  The next scientific milestone is a
prespecified held-out-register or later-wave study.
...
machinery.  The numeric freeze cited in \S\ref{sec:evidence} is still 0.3.0.
